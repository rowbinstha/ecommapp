                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: cubit.imageCategory_addCategoryScreen != null
                              ? Image.file(
                                  cubit.imageCategory_addCategoryScreen!,
                                  fit: BoxFit.cover,
                                )
                              : Icon(Icons.camera_alt_outlined),
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            TextButton(
                              onPressed: () {
                                cubit.categoryAttributes_addCategoryScreen
                                    .add(attributeController.text.toString());
                        ...
                        ListView.separated(
                          ...
                          itemCount:
                              cubit.categoryAttributes_addCategoryScreen.length,
                          itemBuilder: (context, index) => Text(cubit
                              .categoryAttributes_addCategoryScreen[index]),
      ...
      return TextButton(
        onPressed: () {
          ...
          if (formKey.currentState!.validate()) {
            ...
            cubit
                .postImage(cubit.imageCategory_addCategoryScreen!)
                .then((value) {
              if (value.statusCode == 200) {
                Log.v("Success post image");
                AppCubit.get(context).postNewCategory_addCategoryScreen(
                    catrgoryName,
                    categoryDescription,
                    value.data.toString(),
                    context);
